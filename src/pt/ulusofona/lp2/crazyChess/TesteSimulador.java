...
public class TesteSimulador {
    ...
    public void test04ProcessaJogada(){
        ...
        assertEquals(1, rei.getX());
        assertEquals(0, rei.getY());
    ...
    @Test
    public void test05ProcessaJogada(){
        Simulador simulador = new Simulador();
        CrazyPiece rei = new CrazyPiece(1,0, 1, "rei");
        Tabuleiro tabuleiro = new Tabuleiro(4);
        ...
        assertTrue(simulador.processaJogada(2,3,3,2));
        assertEquals(3, rei.getX());
        assertEquals(2, rei.getY());
    }
}
